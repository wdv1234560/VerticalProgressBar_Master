...
public class VerticalProgressBar extends View {
    ...
    private void initByAttributes(TypedArray attributes) {
        ...
        //设置字体颜色
        mTextColor = attributes.getColor(R.styleable.VerticalProgressBar_vp_text_color, default_unfinished_color);
        //设置是否有边框
        mHasLine = attributes.getBoolean(R.styleable.VerticalProgressBar_vp_hasline, false);
        //设置是否有字体
        mHasText = attributes.getBoolean(R.styleable.VerticalProgressBar_vp_hasText, false);
        setMax(attributes.getFloat(R.styleable.VerticalProgressBar_vp_max, default_max));
        setProgress(attributes.getFloat(R.styleable.VerticalProgressBar_vp_progress, 0));
